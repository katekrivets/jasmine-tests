    ...
    */
    ...
    describe('The menu', () => {
        ...
        it('is hidden', () => {
            ...
            expect(slideMenu.parentElement.classList).toContain('menu-hidden');
        });
    ...
    describe('Initial Entries', () => {
        ...
        it('has at least one entry', (done) => {
            let entries = document.querySelector('.feed').childElementCount;
    ...
    describe('New Feed Selection', () => {
            ...
            */
            ...
            it("changes its loaded content", function(done) {
                ...
                expect(existingFeed).not.toBe(newFeed);
                done();
            });
